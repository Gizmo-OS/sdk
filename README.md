...
```sh
npm install git+ssh://git@github.com:Gizmo-OS/sdk.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/Gizmo-OS/sdk/issues) with questions, bugs, or suggestions.
