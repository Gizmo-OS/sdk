...
[![NPM version](<https://img.shields.io/npm/v/gizmo-sdk.svg?label=npm%20(stable)>)](https://npmjs.org/package/gizmo-sdk) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/gizmo-sdk)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/gizmo-sdk-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://www.stainless.com/docs/guides/publish), this will become: `npm install gizmo-sdk`
...
await client.applications.retrieve('REPLACE_ME', {
  maxRetries: 5,
});
```
...
```ts
import GizmoSDK from 'npm:gizmo-sdk';
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/gizmo-sdk-typescript/issues) with questions, bugs, or suggestions.
